...
class CategoryListView(APIView):
    ...
    def get(self, request):
        ...
        serializer = CategorySerializer(categories, many=True, context={'request': request}) # Add context for absolute path
...
class ProductListView(APIView):
    ...
    def get(self, request):
        ...
        serializer = ProductSerializer(products, many=True, context={'request': request}) # Add context for absolute path
        return Response(serializer.data)
...
class FileListView(APIView):
    ...
    def get(self, request, product_id):
        ...
        serializer = FileSerializer(files, many=True, context={'request': request}) # Add context for absolute path
        return Response(serializer.data)
